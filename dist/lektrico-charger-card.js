...
`;const mt="lektrico-charger-card",vt={available:{color:"#4caf50",animation:"none"},connected:{color:"#2196f3",animation:"none"},need_auth:{color:"#2196f3",animation:"pulse"},charging:{color:"#ffffff",animation:"spin"},paused:{color:"#2196f3",animation:"pulse"},paused_by_scheduler:{color:"#2196f3",animation:"pulse"},locked:{color:"#ff5722",animation:"none"},error:{color:"#f44336",animation:"pulse"},updating_firmware:{color:"#ab47bc",animation:"pulse"},unavailable:{color:"#616161",animation:"none"},unknown:{color:"#616161",animation:"none"}},yt={en:{available:"Unplugged",connected:"Connected",need_auth:"Waiting for authentication",charging:"Charging",error:"Error",locked:"Locked",paused:"Paused",paused_by_scheduler:"Paused by scheduler",updating_firmware:"Updating firmware",unavailable:"Unavailable",unknown:"Unknown"},it:{available:"Scollegato",connected:"Connesso",need_auth:"In attesa di autenticazione",charging:"In carica",error:"Errore",locked:"Bloccato",paused:"In pausa",paused_by_scheduler:"In pausa (programmata)",updating_firmware:"Aggiornamento firmware",unavailable:"Non disponibile",unknown:"Sconosciuto"}},$t={en:{parameters:"Parameters",info:"Information",actions:"Actions",start:"Start",stop:"Stop",reboot:"Reboot",authentication:"Authentication",lock:"Lock",dynamic_limit:"Charging current",led_brightness:"LED brightness",energy:"Energy",charging_time:"Charging time",temperature:"Temperature",power:"Power",voltage:"Voltage",current:"Current",installation_current:"Installation current",lifetime_energy:"Lifetime energy",limit_reason:"Limit reason",firmware:"Firmware",errors:"Active errors",entity_missing:"Entity not found"},it:{parameters:"Parametri",info:"Informazioni",actions:"Azioni",start:"Avvia",stop:"Ferma",reboot:"Riavvia",authentication:"Autenticazione",lock:"Blocco",dynamic_limit:"Corrente di ricarica",led_brightness:"Luminosità LED",energy:"Energia",charging_time:"Tempo ricarica",temperature:"Temperatura",power:"Potenza",voltage:"Tensione",current:"Corrente",installation_current:"Corrente di installazione",lifetime_energy:"Energia erogata",limit_reason:"Motivo limitazione",firmware:"Firmware",errors:"Errori attivi",entity_missing:"Entità non trovata"}},bt={en:{ev_error:"Vehicle error",ev_diode_short:"Vehicle communication error",overheating:"Overheating",thermal_throttling:"Thermal throttling",metering_error:"Metering error",overcurrent:"Overcurrent",overvoltage:"Overvoltage",undervoltage:"Undervoltage",rcd_error:"RCD error",relay_contacts_welded:"Relay contacts welded"},it:{ev_error:"Errore veicolo",ev_diode_short:"Errore comunicazione veicolo",overheating:"Surriscaldamento",thermal_throttling:"Limitazione termica",metering_error:"Errore misuratore",overcurrent:"Sovracorrente",overvoltage:"Sovratensione",undervoltage:"Sottotensione",rcd_error:"Errore RCD",relay_contacts_welded:"Contatti relè incollati"}},xt={state:{domain:"sensor",keys:["state"],suffixes:["_state","_stato"]},charging_time:{domain:"sensor",keys:["charging_time"],suffixes:["_charging_time","_tempo_ricarica","_tempo_di_ricarica"]},session_energy:{domain:"sensor",keys:["session_energy"],suffixes:["_session_energy","_energia","_energia_sessione","_energy"]},lifetime_energy:{domain:"sensor",keys:["lifetime_energy"],suffixes:["_lifetime_energy","_energia_erogata"]},power:{domain:"sensor",keys:["instant_power","power"],suffixes:["_instant_power","_power","_potenza"],device_class:"power"},voltage:{domain:"sensor",keys:["voltage"],suffixes:["_voltage","_tensione"],device_class:"voltage"},current:{domain:"sensor",keys:["current"],suffixes:["_current","_corrente"],device_class:"current"},installation_current:{domain:"sensor",keys:["installation_current"],suffixes:["_installation_current","_corrente_di_installazione"]},limit_reason:{domain:"sensor",keys:["limit_reason"],suffixes:["_limit_reason","_motivo_limitazione"]},temperature:{domain:"sensor",keys:["temperature"],suffixes:["_temperature","_temperatura"],device_class:"temperature"},dynamic_limit:{domain:"number",keys:["dynamic_limit"],suffixes:["_dynamic_limit","_limite_dinamico"]},led_brightness:{domain:"number",keys:["led_max_brightness"],suffixes:["_led_max_brightness","_led_brightness","_luminosita_led","_luminosita_massima_led"]},authentication:{domain:"switch",keys:["authentication"],suffixes:["_authentication","_autenticazione"]},lock:{domain:"switch",keys:["lock"],suffixes:["_lock","_blocca","_blocco"]},charge_start:{domain:"button",keys:["charge_start"],suffixes:["_charge_start","_avvia_ricarica"]},charge_stop:{domain:"button",keys:["charge_stop"],suffixes:["_charge_stop","_ferma_ricarica","_arresta_ricarica"]},update:{domain:"update",keys:["firmware"],suffixes:["_firmware"]}},wt=["ev_error","ev_diode_short","overheating","thermal_throttling","metering_error","overcurrent","overvoltage","undervoltage","rcd_error","relay_contacts_welded"],At={slowest:6,fastest:2},St=[6,10,13,16,20,25,32],kt=[10,25,50,75,100];class Et extends at{static styles=gt;static properties={hass:{attribute:!1},_config:{state:!0},_openSection:{state:!0},_pendingSlider:{state:!0}};constructor(){super(),this._openSection=null,this._pendingSlider={},this._roles=null,this._rolesKey=null}setConfig(t){if(!t.entity)throw new Error("Please define the charger state entity, e.g. entity: sensor.1p7k_state");this._config=t,this._roles=null,this._rolesKey=null}getCardSize(){return this._config?.compact?4:8}static getStubConfig(t){const e=t?.entities||{},i=Object.values(e).find(t=>"lektrico"===t.platform&&"state"===t.translation_key);return{entity:i?i.entity_id:"sensor.1p7k_state"}}get _lang(){return(this._config.language||this.hass?.language||"en").split("-")[0]}_t(t){const e=$t[this._lang]?this._lang:"en";return $t[e][t]||$t.en[t]||t}_stateText(t){const e=this._config.state_text||{};if(e[t])return e[t];const i=yt[this._lang]?this._lang:"en";return yt[i][t]||t}_errorName(t,e){const i=bt[this._lang]?this._lang:"en";return bt[i][t]||e?.attributes.friendly_name||t}_discover(){const t=this.hass,e=this._config.entity,i=t.entities||{},s=i[e]?.device_id,r=`${e}|${s||"nodevice"}`;if(this._roles&&this._rolesKey===r)return this._roles;const n=this._config.entities||{},o=s?Object.values(i).filter(t=>t.device_id===s):[],a=e.split(".")[1].replace(/_(state|stato)$/,""),c={};for(const[e,i]of Object.entries(xt)){if(n[e]){c[e]=n[e];continue}let s;if(o.length&&(s=o.find(t=>t.entity_id.startsWith(`${i.domain}.`)&&i.keys?.includes(t.translation_key))),!s){const e=o.length?o.map(t=>t.entity_id):Object.keys(t.states).filter(t=>t.startsWith(`${i.domain}.${a}`));for(const t of i.suffixes||[]){const r=e.find(e=>e.startsWith(`${i.domain}.`)&&e.endsWith(t));if(r){s=r;break}}}if(!s&&i.device_class&&o.length){const e=o.filter(e=>e.entity_id.startsWith(`${i.domain}.`)&&t.states[e.entity_id]?.attributes.device_class===i.device_class);1===e.length&&(s=e[0])}s&&(c[e]=s.entity_id||s)}c.state=c.state||e;let l=[];return l=Array.isArray(n.errors)?n.errors:o.length?o.filter(t=>t.entity_id.startsWith("binary_sensor.")&&(wt.includes(t.translation_key)||wt.some(e=>t.entity_id.endsWith(`_${e}`)))).map(t=>t.entity_id):wt.map(t=>`binary_sensor.${a}_${t}`).filter(e=>t.states[e]),c.errors=l,this._roles=c,this._rolesKey=r,c}_stateObj(t){if(!t)return;if(t.includes("."))return this.hass.states[t];const e=this._discover()[t];return e?this.hass.states[e]:void 0}_errorKeyOf(t){const e=wt.find(e=>t.endsWith(`_${e}`));return e||(this.hass.entities?.[t]?.translation_key||t)}_fmt(t){if(!t)return"—";const{state:e,attributes:i}=t;if("unavailable"===e||"unknown"===e)return"—";if("duration"===i.device_class&&!Number.isNaN(Number(e))){const t=Math.round(Number(e));return`${String(Math.floor(t/3600)).padStart(2,"0")}:${String(Math.floor(t%3600/60)).padStart(2,"0")}:${String(t%60).padStart(2,"0")}`}if("function"==typeof this.hass.formatEntityState)try{return this.hass.formatEntityState(t)}catch(t){}return`${e}${i.unit_of_measurement?` ${i.unit_of_measurement}`:""}`}_moreInfo(t){t&&((t,e,i={})=>{const s=new Event(e,{bubbles:!0,composed:!0});s.detail=i,t.dispatchEvent(s)})(this,"hass-more-info",{entityId:t})}_pressButton(t){const e=this._stateObj(t);e&&this.hass.callService("button","press",{entity_id:e.entity_id})}_toggleSwitch(t){const e=this._stateObj(t);e&&this.hass.callService("switch","toggle",{entity_id:e.entity_id})}_setNumber(t,e){const i=this._stateObj(t);i&&this.hass.callService("number","set_value",{entity_id:i.entity_id,value:e})}_sliderInput(t,e){this._pendingSlider={...this._pendingSlider,[t]:Number(e.target.value)}}_sliderChange(t,e){const i=Number(e.target.value),s={...this._pendingSlider};delete s[t],this._pendingSlider=s,this._setNumber(t,i)}_runAction(t){if(!t.service)return void(t.entity&&this._moreInfo(t.entity));if(t.confirm&&!window.confirm(!0===t.confirm?`${t.text}?`:t.confirm))return;const[e,i]=t.service.split("."),s={...t.service_data||t.data||{}};this.hass.callService(e,i,s,t.target)}_toggleSection(t){this._openSection=this._openSection===t?null:t}render(){if(!this.hass||!this._config)return K;const t=this._discover(),e=this.hass.states[t.state];if(!e)return q`<ha-card>
    ...
    `}_renderTop(t){if(!1===this._config.show_image)return K;const e=this._config.info_left??["current","dynamic_limit"],i=this._config.info_right??["voltage","power"];return q`
      <div class="top">
    ...
    `}_renderInfoItem(t){const e="string"==typeof t?{entity:t}:t,i=this._stateObj(e.entity);if(!i)return K;const s=e.label||("string"==typeof t&&$t.en[t]?this._t(t):i.attributes.friendly_name);return q`
      <div
        class="info-item"
    ...
    `}_ledConfig(t){const e=this._config.led_states||{};return{...vt[t]||vt.unknown,...e[t]||{}}}_ledPeriod(){const t=this._stateObj("current"),e=this._stateObj("dynamic_limit");let i=Number(t?.state);i&&!Number.isNaN(i)||(i=Number(e?.state)||8);const{slowest:s,fastest:r}={...At,...this._config.led_spin||{}},n=s-Math.min(i,32)/32*(s-r);return`${Math.max(n,r).toFixed(2)}s`}_renderImage(t){const e=this._ledConfig(t),i={"--led-color":e.color,"--led-period":this._ledPeriod()},s=`leds anim-${e.animation||"none"}`,r=this._config.image,n=!1!==this._config.show_leds;let o;if(r&&"svg"!==r){const t=this._config.led_overlay_position||{},e={...i,"--led-overlay-left":t.left,"--led-overlay-top":t.top,"--led-overlay-size":t.size};o=q`
        <img class="custom-image" src=${r} alt="charger" />
        ${n?q`<div class=${s} style=${ft(e)}>
              ${B`
  <svg
...
`}
    ...
    `}_renderStatus(t,e){const i=this._config.name||t.attributes.friendly_name,s=this._config.location,r=this._config.substatus_entity?this.hass.states[this._config.substatus_entity]:void 0;return q`
      <div class="status" @click=${()=>this._moreInfo(this._config.entity)}>
        ...
        ${r&&r.state?q`<div class="substatus">${r.state}</div>`:K}
      </div>
    ...
    `}_renderQuickActions(t){const e=this._stateObj("charge_start"),i=this._stateObj("charge_stop"),s=this._stateObj("authentication"),r=this._stateObj("lock"),n=[];return e&&n.push(q`
        <button
          class="qa-button"
          .disabled=${"charging"===t}
      ...
      <div class="sections">
        ${e.map(t=>q`
            <div class="section">
              ...
              ${this._openSection===t.id?q`<div class="section-body">${t.body()}</div>`:K}
            </div>
          `)}
      </div>
    `}_renderSlider(t,e,i,s){const r=this._stateObj(t);if(!r)return K;const n=r.attributes,o=Number(n.min??0),a=Number(n.max??100),c=Number(n.step??1),l=Number(r.state),d=this._pendingSlider[t]??(Number.isNaN(l)?o:l),h=s||n.unit_of_measurement||"",p=(i||[]).filter(t=>t>=o&&t<=a);return q`
    ...
    `}_renderParameters(){const t=this._stateObj("authentication"),e=this._stateObj("lock");return q`
      ${this._renderSlider("dynamic_limit","dynamic_limit",this._config.current_presets??St,"A")}
      ${this._renderSlider("led_brightness","led_brightness",this._config.brightness_presets??kt,"%")}
    ...
    `}_renderInfoList(){const t=(this._config.info_items??[{entity:"installation_current",icon:"mdi:gauge"},{entity:"lifetime_energy",icon:"mdi:counter"},{entity:"limit_reason",icon:"mdi:information-outline"},{entity:"temperature",icon:"mdi:thermometer"}]).map(t=>{const e="string"==typeof t?{entity:t}:t,i=this._stateObj(e.entity);if(!i)return K;const s=e.label||($t.en[e.entity]?this._t(e.entity):i.attributes.friendly_name);return q`
        ...
        `}).filter(t=>t!==K),e=this._stateObj("update");return e&&t.push(q`
        <div
          class="info-row"
      ...
      `),q`<div class="info-list">${t}</div>`}_renderActions(t){return q`
    ...
    `}_renderStats(t,e){const i=[{entity:"session_energy",label:this._t("energy")},{entity:"charging_time",label:this._t("charging_time")},{entity:"temperature",label:this._t("temperature")}],s=this._config.stats||{};let r=Array.isArray(s)?s:s[t]||s.default||i;return"error"===t&&e.length&&!s.error&&(r=e.map(t=>({entity:t.entity_id,label:this._errorName(this._errorKeyOf(t.entity_id),t),value:"⚠"}))),q`
      <div class="stats">
        ${r.map(t=>{const e="string"==typeof t?{entity:t}:t,i=this._stateObj(e.entity);if(!i)return K;const s=e.label||($t.en[e.entity]?this._t(e.entity):i.attributes.friendly_name);return q`
            <div
              class="stat"
              @click=${()=>this._moreInfo(i.entity_id)}
            >
    ...
    `}}customElements.get(mt)||customElements.define(mt,Et),window.customCards=window.customCards||[],window.customCards.some(t=>t.type===mt)||window.customCards.push({type:mt,name:"Lektri.co Charger Card",description:"Card for Lektri.co EV chargers (1P7K / One / 3P22K / Tri) with animated status LEDs.",preview:!0}),console.info("%c LEKTRICO-CHARGER-CARD %c v1.0.0 ","color: white; background: #1b1c1e; font-weight: 700;","color: #4caf50; background: #26282a; font-weight: 700;");
